const defualtProducts = [
    {
        ...
        price: "₹29",
        quantity: 10,
        img: "./assets/images/product/product-1.webp",
    ...
    },
    {
        ...
        price: "₹23",
        quantity: 10,
        img: "./assets/images/product/product-2.webp",
        desc: "A nourishing cream that hydrates and soothes the scalp, promoting healthy hair growth.",
    },
    {
        pid: 1003,
        ...
        price: "₹25",
        quantity: 10,
        img: "./assets/images/product/product-3.webp",
        desc: "A nourishing cream that hydrates and soothes the scalp, promoting healthy hair growth.",
    },
    {
        pid: 1004,
        ...
        price: "₹31",
        quantity: 10,
        img: "./assets/images/product/product-4.webp",
        desc: "A nourishing cream that hydrates and soothes the scalp, promoting healthy hair growth.",
    }
...
function displayProduct() {
    ...
    <a href="./product_details.html?id=${p.pid}" class="btn btn-dark">View Product</a>
